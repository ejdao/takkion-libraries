import { SelectionModel, isDataSource } from '@takkion/cdk/collections';
...
class CdkTree {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      isInline: true,
      dependencies: [
        { kind: 'directive', type: CdkTreeNodeOutlet, selector: '[cdkTreeNodeOutlet]' },
      ],
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: () => [{ type: i0.IterableDiffers }, { type: i0.ChangeDetectorRef }],
  propDecorators: {
    dataSource: [
      {
        type: Input,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: () => [{ type: i0.ElementRef }, { type: CdkTree }],
  propDecorators: {
    role: [
      {
        type: Input,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: () => [{ type: i0.ElementRef }, { type: CdkTree }, { type: i0.IterableDiffers }],
  propDecorators: {
    nodeOutlet: [
      {
        type: ContentChildren,
...
class CdkTreeNodeToggle {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      inputs: { recursive: ['cdkTreeNodeToggleRecursive', 'recursive', booleanAttribute] },
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: () => [{ type: CdkTree }, { type: CdkTreeNode }],
  propDecorators: {
    recursive: [
      {
        type: Input,
