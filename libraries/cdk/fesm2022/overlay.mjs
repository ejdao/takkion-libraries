...
export { CdkScrollable, ScrollDispatcher, ViewportRuler } from '@takkion/cdk/scrolling';
...
import { coerceCssPixelValue, coerceArray } from '@takkion/cdk/coercion';
import * as i1$1 from '@takkion/cdk/platform';
import { supportsScrollBehavior, _getEventTarget, _isTestEnvironment } from '@takkion/cdk/platform';
import { filter, take, takeUntil, takeWhile } from 'rxjs/operators';
import * as i5 from '@takkion/cdk/bidi';
import { BidiModule } from '@takkion/cdk/bidi';
import { DomPortalOutlet, TemplatePortal, PortalModule } from '@takkion/cdk/portal';
...
const CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY = new InjectionToken(
