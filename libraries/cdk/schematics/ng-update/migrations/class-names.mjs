...
class ClassNamesMigration extends migration_1.Migration {
  ...
  _visitIdentifier(identifier) {
    ...
    if (
      (0, imports_1.isNamespaceImportNode)(identifier) &&
      (0, module_specifiers_1.isMaterialImportDeclaration)(identifier)
    ) {
    ...
    if (
      (0, imports_1.isExportSpecifierNode)(identifier) &&
      (0, module_specifiers_1.isMaterialExportDeclaration)(identifier)
    ) {
      return this._createFailureWithReplacement(identifier);
    }
    ...
    if (
      (0, imports_1.isImportSpecifierNode)(identifier) &&
      (0, module_specifiers_1.isMaterialImportDeclaration)(identifier)
    ) {
