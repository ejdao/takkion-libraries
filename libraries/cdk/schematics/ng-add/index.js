 ...
 * automatically executed if developers run `ng add @takkion/cdk`.
 *
...
function default_1() {
  return (host, context) => {
    // The CLI inserts `@takkion/cdk` into the `package.json` before this schematic runs. This
    ...
    if ((0, package_config_1.getPackageVersionFromPackageJson)(host, '@takkion/cdk') === null) {
      // In order to align the CDK version with other Angular dependencies that are setup by
      // `@schematics/angular`, we use tilde instead of caret. This is default for Angular
      // dependencies in new CLI projects.
      (0, package_config_1.addPackageToPackageJson)(host, '@takkion/cdk', `~17.3.1`);
