...
export declare class CdkCopyToClipboard implements OnDestroy {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    '[cdkCopyToClipboard]',
    never,
    { text: 'cdkCopyToClipboard'; attempts: 'cdkCopyToClipboardAttempts' },
...
declare namespace i1 {
  export { CdkCopyToClipboardConfig, CDK_COPY_TO_CLIPBOARD_CONFIG, CdkCopyToClipboard };
}
