...
import { CdkScrollable } from '@takkion/cdk/scrolling';
...
import * as i3 from '@takkion/cdk/portal';
import * as i4 from '@takkion/cdk/scrolling';
...
import { PortalOutlet } from '@takkion/cdk/portal';
...
/** @docs-private */
declare function CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY_PROVIDER_FACTORY(
  overlay: Overlay
...
export declare class CloseScrollStrategy implements ScrollStrategy {
  ...
  constructor(
    ...
    _config?: CloseScrollStrategyConfig | undefined
  );
  /** Attaches this scroll strategy to an overlay. */
...
export declare class Overlay {
  ...
  constructor(
    ...
    _animationsModuleType?: string | undefined
  );
  /**
   * Creates an overlay.
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<
    Overlay,
    [null, null, null, null, null, null, null, null, null, null, null, { optional: true }]
  >;
...
export declare class OverlayModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    OverlayModule,
    [typeof i1.CdkConnectedOverlay, typeof i1.CdkOverlayOrigin],
    [typeof i2.BidiModule, typeof i3.PortalModule, typeof i4.ScrollingModule],
    [typeof i1.CdkConnectedOverlay, typeof i1.CdkOverlayOrigin, typeof i4.ScrollingModule]
  >;
...
export declare class RepositionScrollStrategy implements ScrollStrategy {
  ...
  constructor(
    ...
    _viewportRuler: ViewportRuler,
    _ngZone: NgZone,
    _config?: RepositionScrollStrategyConfig | undefined
  );
  /** Attaches this scroll strategy to an overlay. */
  attach(overlayRef: OverlayReference): void;
 ...
 * @docs-private
 */
export declare function validateHorizontalPosition(
  property: string,
 ...
 * @docs-private
 */
export declare function validateVerticalPosition(
  property: string,
