...
import { _getEventTarget, normalizePassiveListenerOptions, _getShadowRoot } from '@takkion/cdk/platform';
import { coerceBooleanProperty, coerceElement, coerceArray, coerceNumberProperty } from '@takkion/cdk/coercion';
import { isFakeTouchstartFromScreenReader, isFakeMousedownFromScreenReader } from '@takkion/cdk/a11y';
