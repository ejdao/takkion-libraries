...
import { Overlay, OverlayConfig, OverlayRef, OverlayModule } from '@takkion/cdk/overlay';
import { _getFocusedElementPierceShadowDom } from '@takkion/cdk/platform';
import * as i3 from '@takkion/cdk/portal';
import { BasePortalOutlet, CdkPortalOutlet, ComponentPortal, TemplatePortal, PortalModule } from '@takkion/cdk/portal';
