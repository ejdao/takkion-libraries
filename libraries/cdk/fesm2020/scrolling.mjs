import { coerceNumberProperty, coerceElement, coerceBooleanProperty } from '@takkion/cdk/coercion';
...
import { getRtlScrollAxisType, supportsScrollBehavior, Platform } from '@takkion/cdk/platform';
import { DOCUMENT } from '@angular/common';
import * as i2 from '@takkion/cdk/bidi';
import { BidiModule } from '@takkion/cdk/bidi';
import * as i2$1 from '@takkion/cdk/collections';
import { isDataSource, ArrayDataSource, _VIEW_REPEATER_STRATEGY, _RecycleViewRepeaterStrategy } from '@takkion/cdk/collections';
