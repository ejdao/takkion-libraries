 ...
 */
export declare class _DisposeViewRepeaterStrategy<T, R, C extends _ViewRepeaterItemContext<T>>
 ...
 * @template C The type for the context passed to each embedded view.
 */
export declare class _RecycleViewRepeaterStrategy<T, R, C extends _ViewRepeaterItemContext<T>>
  implements _ViewRepeater<T, R, C>
{
  /**
 ...
 * @docs-private
 */
export declare const _VIEW_REPEATER_STRATEGY: InjectionToken<
 ...
 * @template C The type for the context passed to each embedded view.
 */
export declare type _ViewRepeaterItemChanged<R, C> = (
 ...
 * @template C The type for the context passed to each embedded view.
 */
export declare type _ViewRepeaterItemContextFactory<T, R, C extends _ViewRepeaterItemContext<T>> = (
  record: IterableChangeRecord<R>,
