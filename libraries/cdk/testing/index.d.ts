 ...
 */
export declare abstract class ContentContainerComponentHarness<S extends string = string>
 ...
 */
export declare function _getTextWithExcludedElements(
  element: Element,
 ...
 */
export declare function handleAutoChangeDetectionStatus(
 ...
 * a `HarnessPredicate`.
 */
export declare type HarnessQuery<T extends ComponentHarness> =
...
export declare type LocatorFnResult<T extends (HarnessQuery<any> | string)[]> = {
  [I in keyof T]: T[I] extends new (...args: any[]) => infer C
    ? C
    : T[I] extends {
 ...
 */
export declare function parallel<T1, T2, T3, T4, T5>(
  values: () => [
    T1 | PromiseLike<T1>,
    T2 | PromiseLike<T2>,
    T3 | PromiseLike<T3>,
 ...
 * @return The resolved values.
 */
export declare function parallel<T1, T2, T3, T4>(
  values: () => [
    T1 | PromiseLike<T1>,
    T2 | PromiseLike<T2>,
    T3 | PromiseLike<T3>,
 ...
 * @return The resolved values.
 */
export declare function parallel<T1, T2, T3>(
 ...
 * @return The resolved values.
 */
export declare function parallel<T1, T2>(
