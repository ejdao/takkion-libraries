...
import { Highlightable } from '@takkion/cdk/a11y';
import * as i0 from '@angular/core';
import { ListKeyManagerOption } from '@takkion/cdk/a11y';
...
export declare class CdkListbox<T = unknown>
  implements AfterContentInit, OnDestroy, ControlValueAccessor, Validator
{
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    {
      id: 'id';
      enabledTabIndex: 'tabindex';
      value: 'cdkListboxValue';
      multiple: 'cdkListboxMultiple';
      disabled: 'cdkListboxDisabled';
      useActiveDescendant: 'cdkListboxUseActiveDescendant';
      orientation: 'cdkListboxOrientation';
      compareWith: 'cdkListboxCompareWith';
      navigationWrapDisabled: 'cdkListboxNavigationWrapDisabled';
      navigateDisabledOptions: 'cdkListboxNavigatesDisabledOptions';
    },
...
export declare class CdkListboxModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    CdkListboxModule,
    [typeof i1.CdkListbox, typeof i1.CdkOption],
    never,
    [typeof i1.CdkListbox, typeof i1.CdkOption]
  >;
...
export declare class CdkOption<T = unknown>
  implements ListKeyManagerOption, Highlightable, OnDestroy
{
  /** The id of the option's host element. */
  get id(): string;
  set id(value: string);
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    ['cdkOption'],
    {
      id: 'id';
      value: 'cdkOption';
      typeaheadLabel: 'cdkOptionTypeaheadLabel';
      disabled: 'cdkOptionDisabled';
      enabledTabIndex: 'tabindex';
    },
    {},
    never,
...
declare namespace i1 {
  export { CdkOption, CdkListbox, ListboxValueChangeEvent };
}
