 ...
 */
import { ALT, CONTROL, MAC_META, META, SHIFT } from '@takkion/cdk/keycodes';
import { Inject, Injectable, InjectionToken, Optional, NgZone } from '@angular/core';
import { normalizePassiveListenerOptions, Platform, _getEventTarget } from '@takkion/cdk/platform';
 ...
 * options.
 */
export const INPUT_MODALITY_DETECTOR_OPTIONS = new InjectionToken(
