...
import * as i7 from '@takkion/cdk/scrolling';
...
export declare class CdkDrag<T = any> implements AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(
    ...
    _selfHandle?: CdkDragHandle | undefined,
    _parentDrag?: CdkDrag<any> | undefined
  );
  /**
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    ['cdkDrag'],
    {
      ...
      previewContainer: 'cdkDragPreviewContainer';
    },
    {
...
export declare class CdkDropList<T = any> implements OnDestroy {
  ...
  constructor(
    ...
    _group?: CdkDropListGroup<CdkDropList<any>> | undefined,
    config?: DragDropConfig
  );
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    ['cdkDropList'],
    {
      ...
      autoScrollStep: 'cdkDropListAutoScrollStep';
    },
    {
 ...
 *
 */
export declare function copyArrayItem<T = any>(
  currentArray: T[],
  targetArray: T[],
  currentIndex: number,
  targetIndex: number
...
export declare class DragDrop {
  ...
  constructor(
    ...
    _dragDropRegistry: DragDropRegistry<DragRef, DropListRef>
  );
  /**
...
export declare class DragDropModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    DragDropModule,
    [
      typeof i1.CdkDropList,
      typeof i2.CdkDropListGroup,
      typeof i3.CdkDrag,
      typeof i4.CdkDragHandle,
      typeof i5.CdkDragPreview,
      typeof i6.CdkDragPlaceholder,
    ],
    never,
    [
 ...
 * @docs-private
 */
export declare class DragDropRegistry<
  I extends {
    isDragging(): boolean;
  },
  C,
...
export declare class DragRef<T = any> {
  ...
  constructor(
    ...
    _ngZone: NgZone,
    _viewportRuler: ViewportRuler,
    _dragDropRegistry: DragDropRegistry<DragRef, DropListRefInternal>
  );
  /**
   * Returns the element that is being used as a placeholder
   * while the current element is being dragged.
...
export declare type DragStartDelay =
  | number
  | {
      touch: number;
      mouse: number;
...
export declare class DropListRef<T = any> {
  ...
  constructor(
    element: ElementRef<HTMLElement> | HTMLElement,
    _dragDropRegistry: DragDropRegistry<DragRefInternal, DropListRef>,
    _document: any,
    _ngZone: NgZone,
    _viewportRuler: ViewportRuler
  );
...
declare namespace i1 {
  export { CdkDropListInternal, CDK_DROP_LIST, CdkDropList };
}

declare namespace i2 {
  export { CDK_DROP_LIST_GROUP, CdkDropListGroup };
}
...
declare namespace i4 {
  export { CDK_DRAG_HANDLE, CdkDragHandle };
}

declare namespace i5 {
  export { CDK_DRAG_PREVIEW, CdkDragPreview };
}

declare namespace i6 {
  export { CDK_DRAG_PLACEHOLDER, CdkDragPlaceholder };
}
 ...
 */
export declare function moveItemInArray<T = any>(
  array: T[],
  fromIndex: number,
  toIndex: number
): void;
 ...
 * @param targetIndex Index at which to insert the item.
 */
export declare function transferArrayItem<T = any>(
  currentArray: T[],
  targetArray: T[],
  currentIndex: number,
  targetIndex: number
