...
import { ContentObserver } from '@takkion/cdk/observers';
...
export declare class A11yModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    [
      ...
      typeof i2.CdkAriaLive,
      typeof i3.CdkTrapFocus,
      typeof i4.CdkMonitorFocus,
    ],
    [typeof i2.CdkAriaLive, typeof i3.CdkTrapFocus, typeof i4.CdkMonitorFocus]
  >;
 ...
 * Used for attributes such as aria-labelledby, aria-owns, etc.
 */
export declare function removeAriaReferencedId(
  el: Element,
  attr: `aria-${string}`,
  id: string
): void;
