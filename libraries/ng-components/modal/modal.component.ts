...
export class TakModalComponent implements OnInit {
  ...
  public onConfirm(): void {
    if (!this.hasTextArea) this._dialogRef.close(true);
    else this._dialogRef.close({ success: true, textArea: this.textArea });
  }

  public onClose(): void {
    if (!this.hasTextArea) this._dialogRef.close(false);
    else this._dialogRef.close({ success: false, textArea: this.textArea });
  }
