...
class TakBottomSheet {
  ...
  open(componentOrTemplateRef, config) {
    const _config = Object.assign(
      Object.assign({}, this._defaultOptions || new TakBottomSheetConfig()),
      config
    );
    let ref;
    this._dialog.open(
      componentOrTemplateRef,
      Object.assign(Object.assign({}, _config), {
    ...
    if (this._openedBottomSheetRef) {
      ...
      this._openedBottomSheetRef.afterDismissed().subscribe(() => {
        var _a;
        return (_a = ref.containerInstance) === null || _a === void 0 ? void 0 : _a.enter();
      });
