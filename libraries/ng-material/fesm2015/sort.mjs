...
class TakSort extends _TakSortBase {
  ...
  getNextSortDirection(sortable) {
    ...
    const disableClear =
      (_b =
        (_a = sortable === null || sortable === void 0 ? void 0 : sortable.disableClear) !== null &&
        _a !== void 0
          ? _a
          : this.disableClear) !== null && _b !== void 0
        ? _b
        : !!((_c = this._defaultOptions) === null || _c === void 0 ? void 0 : _c.disableClear);
...
class TakSortHeader extends _TakSortHeaderBase {
  constructor(
    ...
    if (
      defaultOptions === null || defaultOptions === void 0 ? void 0 : defaultOptions.arrowPosition
    ) {
      this.arrowPosition =
        defaultOptions === null || defaultOptions === void 0
          ? void 0
          : defaultOptions.arrowPosition;
    }
  ...
  _updateSortActionDescription(newDescription) {
    ...
    if (this._sortButton) {
      ...
      (_a = this._ariaDescriber) === null || _a === void 0
        ? void 0
        : _a.removeDescription(this._sortButton, this._sortActionDescription);
      (_b = this._ariaDescriber) === null || _b === void 0
        ? void 0
        : _b.describe(this._sortButton, newDescription);
    }
