 ...
 * @docs-private
 */
const TAK_PROGRESS_BAR_LOCATION = new InjectionToken('tak-progress-bar-location', {
  providedIn: 'root',
  factory: TAK_PROGRESS_BAR_LOCATION_FACTORY,
});
/** @docs-private */
function TAK_PROGRESS_BAR_LOCATION_FACTORY() {
...
const TAK_PROGRESS_BAR_DEFAULT_OPTIONS = new InjectionToken('TAK_PROGRESS_BAR_DEFAULT_OPTIONS');
/** Counter used to generate unique IDs for progress bars. */
let progressbarId = 0;
/**
 * `<tak-progress-bar>` component.
 */
class TakProgressBar extends _TakProgressBarBase {
  constructor(
    elementRef,
    _ngZone,
    _animationMode,
 ...
 * found in the LICENSE file at https://angular.io/license
 */
class TakProgressBarModule {}
TakProgressBarModule.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: TakProgressBarModule,
  deps: [],
  target: i0.ɵɵFactoryTarget.NgModule,
});
TakProgressBarModule.ɵmod = i0.ɵɵngDeclareNgModule({
  minVersion: '14.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: TakProgressBarModule,
  declarations: [TakProgressBar],
  imports: [CommonModule, TakCommonModule],
  exports: [TakProgressBar, TakCommonModule],
});
TakProgressBarModule.ɵinj = i0.ɵɵngDeclareInjector({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: TakProgressBarModule,
