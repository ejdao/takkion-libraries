...
import { TakOptgroup, _TakOptgroupBase, TAK_OPTGROUP } from './optgroup';
import { TAK_OPTION_PARENT_COMPONENT } from './option-parent';
...
export class TakOptionSelectionChange {
  constructor(
 ...
 */
export class TakOption extends _TakOptionBase {
