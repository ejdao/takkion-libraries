...
export class _TakOptgroupBase extends _TakOptgroupMixinBase {
  constructor(parent) {
    super();
 ...
 */
export const TAK_OPTGROUP = new InjectionToken('TakOptgroup');
/**
 * Component that is used to group instances of `tak-option`.
 */
export class TakOptgroup extends _TakOptgroupBase {}
