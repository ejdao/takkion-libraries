...
import { TakExpansionPanel, TAK_EXPANSION_PANEL_DEFAULT_OPTIONS } from './expansion-panel';
 ...
 */
export class TakExpansionPanelHeader extends _TakExpansionPanelHeaderMixinBase {
  constructor(
    panel,
    _element,
    _focusMonitor,
...
TakExpansionPanelHeader.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  deps: [
    { token: i1.TakExpansionPanel, host: true },
    { token: i0.ElementRef },
 ...
 */
export class TakExpansionPanelDescription {}
 ...
 */
export class TakExpansionPanelTitle {}
