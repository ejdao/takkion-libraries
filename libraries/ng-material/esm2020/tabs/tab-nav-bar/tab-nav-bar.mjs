 ...
 * @docs-private
 */
export class _TakTabNavBase extends TakPaginatedTabHeader {
 ...
 */
export class TakTabNav extends _TakTabNavBase {
  constructor(elementRef, dir, ngZone, changeDetectorRef, viewportRuler, platform, animationMode) {
...
export class _TakTabLinkBase extends _TakTabLinkMixinBase {
  constructor(
    _tabNavBar,
 ...
 */
export class TakTabLink extends _TakTabLinkBase {
  constructor(
    tabNavBar,
    elementRef,
    ngZone,
