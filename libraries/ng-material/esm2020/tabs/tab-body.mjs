...
import { takTabsAnimations } from './tabs-animations';
 ...
 * @docs-private
 */
export class TakTabBodyPortal extends CdkPortalOutlet {
 ...
 * @docs-private
 */
export class TakTabBody extends _TakTabBodyBase {
