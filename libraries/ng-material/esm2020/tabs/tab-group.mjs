...
import { TAK_TAB_GROUP, TakTab } from './tab';
import { TAK_TABS_CONFIG } from './tab-config';
...
export class TakTabChangeEvent {}
 ...
 * @docs-private
 */
export class _TakTabGroupBase extends _TakTabGroupMixinBase {
 ...
 */
export class TakTabGroup extends _TakTabGroupBase {
...
TakTabGroup.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  dependencies: [
    ...
    {
      kind: 'directive',
      type: i5.TakTabLabelWrapper,
      selector: '[takTabLabelWrapper]',
      inputs: ['disabled'],
    },
    { kind: 'component', type: i6.TakTabBody, selector: 'tak-tab-body' },
    {
      kind: 'component',
      type: i7.TakTabHeader,
