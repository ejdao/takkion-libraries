...
import { TAK_TAB_CONTENT } from './tab-content';
import { TAK_TAB_LABEL, TakTabLabel, TAK_TAB } from './tab-label';
 ...
 * @docs-private
 */
export const TAK_TAB_GROUP = new InjectionToken('TAK_TAB_GROUP');
export class TakTab extends _TakTabBase {
