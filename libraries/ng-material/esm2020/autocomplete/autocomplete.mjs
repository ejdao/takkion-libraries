...
export class TakAutocompleteSelectedEvent {
  constructor(
...
export const TAK_AUTOCOMPLETE_DEFAULT_OPTIONS = new InjectionToken(
  'tak-autocomplete-default-options',
  {
    providedIn: 'root',
...
/** @docs-private */
export function TAK_AUTOCOMPLETE_DEFAULT_OPTIONS_FACTORY() {
  return { autoActiveFirstOption: false, autoSelectActiveOption: false };
}
/** Base class with all of the `TakAutocomplete` functionality. */
export class _TakAutocompleteBase extends _TakAutocompleteMixinBase {
...
export class TakAutocomplete extends _TakAutocompleteBase {
  constructor() {
    super(...arguments);
