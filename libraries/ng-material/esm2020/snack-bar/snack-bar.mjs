...
import { TAK_SNACK_BAR_DATA, TakSnackBarConfig } from './snack-bar-config';
import { TakSnackBarContainer } from './snack-bar-container';
import { TakSnackBarModule } from './snack-bar-module';
import { TakSnackBarRef } from './snack-bar-ref';
...
export const TAK_SNACK_BAR_DEFAULT_OPTIONS = new InjectionToken('tak-snack-bar-default-options', {
  providedIn: 'root',
  factory: TAK_SNACK_BAR_DEFAULT_OPTIONS_FACTORY,
});
/** @docs-private */
export function TAK_SNACK_BAR_DEFAULT_OPTIONS_FACTORY() {
  return new TakSnackBarConfig();
}
export class _TakSnackBarBase {
 ...
 */
export class TakSnackBar extends _TakSnackBarBase {
