...
export const TAK_RADIO_DEFAULT_OPTIONS = new InjectionToken('tak-radio-default-options', {
  providedIn: 'root',
  factory: TAK_RADIO_DEFAULT_OPTIONS_FACTORY,
});
export function TAK_RADIO_DEFAULT_OPTIONS_FACTORY() {
  return {
    color: 'accent',
  };
}
 ...
 */
export const TAK_RADIO_GROUP = new InjectionToken('TakRadioGroup');
/**
 * Base class with all of the `TakRadioGroup` functionality.
 * @docs-private
 */
export class _TakRadioGroupBase {
 ...
 */
export class TakRadioGroup extends _TakRadioGroupBase {}
 ...
 * @docs-private
 */
export class _TakRadioButtonBase extends _TakRadioButtonMixinBase {
  constructor(
    radioGroup,
    elementRef,
    _changeDetector,
 ...
 */
export class TakRadioButton extends _TakRadioButtonBase {
  constructor(
    radioGroup,
    elementRef,
    changeDetector,
