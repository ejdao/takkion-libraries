...
import { TAK_FORM_FIELD, TakFormField, TakFormFieldControl } from '@takkion/ng-material/form-field';
...
import { takSelectAnimations } from './select-animations';
import {
  getTakSelectDynamicMultipleError,
  getTakSelectNonArrayValueError,
  getTakSelectNonFunctionValueError,
} from './select-errors';
...
export const TAK_SELECT_SCROLL_STRATEGY = new InjectionToken('tak-select-scroll-strategy');
/** @docs-private */
export function TAK_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay) {
  return () => overlay.scrollStrategies.reposition();
}
/** Injection token that can be used to provide the default options the select module. */
export const TAK_SELECT_CONFIG = new InjectionToken('TAK_SELECT_CONFIG');
/** @docs-private */
export const TAK_SELECT_SCROLL_STRATEGY_PROVIDER = {
  provide: TAK_SELECT_SCROLL_STRATEGY,
  deps: [Overlay],
  useFactory: TAK_SELECT_SCROLL_STRATEGY_PROVIDER_FACTORY,
};
/** Change event object that is emitted when the select value has changed. */
export class TakSelectChange {
  constructor(
 ...
 */
export const TAK_SELECT_TRIGGER = new InjectionToken('TakSelectTrigger');
/**
 * Allows the user to customize the trigger that is displayed when the select has a value.
 */
export class TakSelectTrigger {}
...
export class _TakSelectBase extends _TakSelectMixinBase {
  constructor(
    _viewportRuler,
    _changeDetectorRef,
    _ngZone,
...
export class TakSelect extends _TakSelectBase {
  constructor() {
    super(...arguments);
