...
export const TAK_PROGRESS_SPINNER_DEFAULT_OPTIONS = new InjectionToken(
...
/** @docs-private */
export function TAK_PROGRESS_SPINNER_DEFAULT_OPTIONS_FACTORY() {
 ...
 */
export class TakProgressSpinner extends _TakProgressSpinnerBase {
  constructor(
    elementRef,
    _platform,
    _document,
