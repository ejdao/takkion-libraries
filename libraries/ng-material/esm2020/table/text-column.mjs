 ...
 * input.
 */
export class TakTextColumn extends CdkTextColumn {}
...
TakTextColumn.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  isInline: true,
  dependencies: [
    { kind: 'directive', type: i1.TakHeaderCellDef, selector: '[takHeaderCellDef]' },
    {
      kind: 'directive',
      type: i1.TakColumnDef,
      selector: '[takColumnDef]',
      inputs: ['sticky', 'takColumnDef'],
    },
    { kind: 'directive', type: i1.TakCellDef, selector: '[takCellDef]' },
    { kind: 'directive', type: i1.TakHeaderCell, selector: 'tak-header-cell, th[tak-header-cell]' },
    { kind: 'directive', type: i1.TakCell, selector: 'tak-cell, td[tak-cell]' },
  ],
