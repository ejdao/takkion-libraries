...
import { TAK_BOTTOM_SHEET_DATA, TakBottomSheetConfig } from './bottom-sheet-config';
import { TakBottomSheetContainer } from './bottom-sheet-container';
import { TakBottomSheetModule } from './bottom-sheet-module';
import { TakBottomSheetRef } from './bottom-sheet-ref';
import * as i0 from '@angular/core';
import * as i1 from '@takkion/ng-cdk/overlay';
import * as i2 from './bottom-sheet-config';
/** Injection token that can be used to specify default bottom sheet options. */
export const TAK_BOTTOM_SHEET_DEFAULT_OPTIONS = new InjectionToken(
  'tak-bottom-sheet-default-options'
);
/**
 * Service to trigger Material Design bottom sheets.
 */
export class TakBottomSheet {
