...
import { TakIconRegistry } from './icon-registry';
...
export const TAK_ICON_DEFAULT_OPTIONS = new InjectionToken('TAK_ICON_DEFAULT_OPTIONS');
/**
 * Injection token used to provide the current location to `TakIcon`.
 * Used to handle server-side rendering and to stub out during unit tests.
 * @docs-private
 */
export const TAK_ICON_LOCATION = new InjectionToken('tak-icon-location', {
  providedIn: 'root',
  factory: TAK_ICON_LOCATION_FACTORY,
});
/** @docs-private */
export function TAK_ICON_LOCATION_FACTORY() {
 ...
 */
export class TakIcon extends _TakIconBase {
