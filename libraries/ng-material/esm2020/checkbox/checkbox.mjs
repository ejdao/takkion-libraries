...
export class _TakCheckboxBase extends _TakCheckboxMixinBase {
  constructor(
    idPrefix,
    elementRef,
    _changeDetectorRef,
 ...
 */
export class TakCheckbox extends _TakCheckboxBase {
  constructor(
    elementRef,
    changeDetectorRef,
    _focusMonitor,
