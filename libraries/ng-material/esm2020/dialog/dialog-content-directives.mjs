...
import { TakDialog } from './dialog';
import { TakDialogRef, _closeDialogVia } from './dialog-ref';
...
TakDialogClose.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  type: TakDialogClose,
  deps: [
    { token: i1.TakDialogRef, optional: true },
    { token: i0.ElementRef },
    { token: i2.TakDialog },
  ],
