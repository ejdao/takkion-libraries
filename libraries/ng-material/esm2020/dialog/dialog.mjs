...
import { TakDialogRef } from './dialog-ref';
...
export const TAK_DIALOG_DATA = new InjectionToken('TakDialogData');
/** Injection token that can be used to specify default dialog options. */
export const TAK_DIALOG_DEFAULT_OPTIONS = new InjectionToken('tak-dialog-default-options');
/** Injection token that determines the scroll handling while the dialog is open. */
export const TAK_DIALOG_SCROLL_STRATEGY = new InjectionToken('tak-dialog-scroll-strategy');
/** @docs-private */
export function TAK_DIALOG_SCROLL_STRATEGY_FACTORY(overlay) {
  return () => overlay.scrollStrategies.block();
}
/** @docs-private */
export function TAK_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY(overlay) {
  return () => overlay.scrollStrategies.block();
}
/** @docs-private */
export const TAK_DIALOG_SCROLL_STRATEGY_PROVIDER = {
 ...
 */
export class TakDialog extends _TakDialogBase {
  constructor(
    overlay,
    injector,
    /**
