...
import { TakPaginatorIntl } from './paginator-intl';
...
export const TAK_PAGINATOR_DEFAULT_OPTIONS = new InjectionToken('TAK_PAGINATOR_DEFAULT_OPTIONS');
 ...
 * @docs-private
 */
export class _TakPaginatorBase extends _TakPaginatorMixinBase {
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: i1.TakPaginatorIntl }, { type: i0.ChangeDetectorRef }, { type: undefined }];
  },
  propDecorators: {
    color: [
      {
 ...
 */
export class TakPaginator extends _TakPaginatorBase {
