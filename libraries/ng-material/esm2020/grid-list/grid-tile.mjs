...
import { TakLine, setLines } from '@takkion/ng-material/core';
import { coerceNumberProperty } from '@takkion/ng-cdk/coercion';
import { TAK_GRID_LIST } from './grid-list-base';
import * as i0 from '@angular/core';
export class TakGridTile {
 ...
 * @docs-private
 */
export class TakGridAvatarCssTakStyler {}
 ...
 * @docs-private
 */
export class TakGridTileHeaderCssTakStyler {}
 ...
 * @docs-private
 */
export class TakGridTileFooterCssTakStyler {}
