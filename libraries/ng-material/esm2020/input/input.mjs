...
import { getTakInputUnsupportedTypeError } from './input-errors';
import { TAK_INPUT_VALUE_ACCESSOR } from './input-value-accessor';
...
export class TakInput extends _TakInputBase {
  constructor(
    _elementRef,
    _platform,
    ngControl,
