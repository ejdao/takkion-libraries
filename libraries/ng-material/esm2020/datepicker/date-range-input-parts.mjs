...
import { TakDatepickerInputBase } from './datepicker-input-base';
 ...
 */
export const TAK_DATE_RANGE_INPUT_PARENT = new InjectionToken('TAK_DATE_RANGE_INPUT_PARENT');
/**
...
export class TakStartDate extends _TakDateRangeInputBase {
  constructor(
    rangeInput,
    elementRef,
...
export class TakEndDate extends _TakDateRangeInputBase {
  constructor(
    rangeInput,
    elementRef,
    defaultErrorStateMatcher,
