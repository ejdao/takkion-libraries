...
import { TakFormFieldControl, TakFormField, TAK_FORM_FIELD } from '@takkion/ng-material/form-field';
import { DateAdapter } from '@takkion/ng-material/core';
import { ControlContainer } from '@angular/forms';
import { Subject, merge, Subscription } from 'rxjs';
import { coerceBooleanProperty } from '@takkion/ng-cdk/coercion';
import { TakStartDate, TakEndDate, TAK_DATE_RANGE_INPUT_PARENT } from './date-range-input-parts';
...
let nextUniqueId = 0;
export class TakDateRangeInput {
...
TakDateRangeInput.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  deps: [
    ...
    { token: i0.ElementRef },
    { token: i1.ControlContainer, optional: true, self: true },
