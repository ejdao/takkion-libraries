...
export const TAK_DATE_RANGE_SELECTION_STRATEGY = new InjectionToken(
  'TAK_DATE_RANGE_SELECTION_STRATEGY'
);
/** Provides the default date range selection behavior. */
export class DefaultTakCalendarRangeStrategy {
...
/** @docs-private */
export function TAK_CALENDAR_RANGE_STRATEGY_PROVIDER_FACTORY(parent, adapter) {
  return parent || new DefaultTakCalendarRangeStrategy(adapter);
}
/** @docs-private */
export const TAK_CALENDAR_RANGE_STRATEGY_PROVIDER = {
