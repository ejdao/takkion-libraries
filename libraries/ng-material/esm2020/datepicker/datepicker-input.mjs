...
import { TakFormField, TAK_FORM_FIELD } from '@takkion/ng-material/form-field';
...
/** @docs-private */
export const TAK_DATEPICKER_VALUE_ACCESSOR = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => TakDatepickerInput),
  multi: true,
};
/** @docs-private */
export const TAK_DATEPICKER_VALIDATORS = {
  provide: NG_VALIDATORS,
  useExisting: forwardRef(() => TakDatepickerInput),
  multi: true,
};
/** Directive used to connect an input to a TakDatepicker. */
export class TakDatepickerInput extends TakDatepickerInputBase {
