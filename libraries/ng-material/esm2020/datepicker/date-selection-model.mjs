 ...
 * @docs-private
 */
export class TakDateSelectionModel {
  constructor(
 ...
 * @docs-private
 */
export class TakSingleDateSelectionModel extends TakDateSelectionModel {
  constructor(adapter) {
    super(null, adapter);
  }
  /**
 ...
 * @docs-private
 */
export class TakRangeDateSelectionModel extends TakDateSelectionModel {
  constructor(adapter) {
...
/** @docs-private */
export function TAK_SINGLE_DATE_SELECTION_MODEL_FACTORY(parent, adapter) {
 ...
 * @docs-private
 */
export const TAK_SINGLE_DATE_SELECTION_MODEL_PROVIDER = {
...
/** @docs-private */
export function TAK_RANGE_DATE_SELECTION_MODEL_FACTORY(parent, adapter) {
 ...
 * @docs-private
 */
export const TAK_RANGE_DATE_SELECTION_MODEL_PROVIDER = {
  provide: TakDateSelectionModel,
  deps: [[new Optional(), new SkipSelf(), TakDateSelectionModel], DateAdapter],
