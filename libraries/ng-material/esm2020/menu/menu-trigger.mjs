...
import { _TakMenuBase } from './menu';
import { throwTakMenuRecursiveError } from './menu-errors';
import { TakMenuItem } from './menu-item';
import { TAK_MENU_PANEL } from './menu-panel';
...
export const TAK_MENU_SCROLL_STRATEGY = new InjectionToken('tak-menu-scroll-strategy');
/** @docs-private */
export function TAK_MENU_SCROLL_STRATEGY_FACTORY(overlay) {
  return () => overlay.scrollStrategies.reposition();
}
/** @docs-private */
export const TAK_MENU_SCROLL_STRATEGY_FACTORY_PROVIDER = {
  provide: TAK_MENU_SCROLL_STRATEGY,
  deps: [Overlay],
  useFactory: TAK_MENU_SCROLL_STRATEGY_FACTORY,
};
/**
...
export class _TakMenuTriggerBase {
  constructor(
    _overlay,
    _element,
    _viewContainerRef,
    scrollStrategy,
    parentMenu,
    // `TakMenuTrigger` is commonly used in combination with a `TakMenuItem`.
    ...
    this._parentMaterialMenu = parentMenu instanceof _TakMenuBase ? parentMenu : undefined;
   ...
   * @breaking-change 8.0.0
   */
  get _deprecatedTakMenuTriggerFor() {
    return this.menu;
  }
  set _deprecatedTakMenuTriggerFor(v) {
    this.menu = v;
  }
  ...
  openMenu() {
    ...
    this._initMenu(menu);
    if (menu instanceof _TakMenuBase) {
  ...
  _createOverlay(menu) {
    if (!this._overlayRef) {
      ...
      // break anybody that may have implemented the `TakMenuPanel` themselves.
  ...
  _getOverlayConfig(menu) {
    return new OverlayConfig({
      positionStrategy: this._overlay
        ...
        .withLockedPosition()
        .withGrowAfterOpen()
        .withTransformOriginOn('.tak-menu-panel, .tak-mdc-menu-panel'),
  ...
  _handleHover() {
    ...
    this._hoverSubscription = this._parentMaterialMenu
      ...
      .subscribe(() => {
        ...
        if (this.menu instanceof _TakMenuBase && this.menu._isAnitaking) {
  ...
  _getPortal(menu) {
    ...
    // `TakMenuPanel`, making it harder to consume.
...
_TakMenuTriggerBase.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: _TakMenuTriggerBase,
  deps: [
    { token: i1.Overlay },
    { token: i0.ElementRef },
    { token: i0.ViewContainerRef },
    { token: TAK_MENU_SCROLL_STRATEGY },
    { token: TAK_MENU_PANEL, optional: true },
    { token: i2.TakMenuItem, optional: true, self: true },
...
_TakMenuTriggerBase.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: _TakMenuTriggerBase,
  inputs: {
    _deprecatedTakMenuTriggerFor: ['tak-menu-trigger-for', '_deprecatedTakMenuTriggerFor'],
    menu: ['takMenuTriggerFor', 'menu'],
    menuData: ['takMenuTriggerData', 'menuData'],
    restoreFocus: ['takMenuTriggerRestoreFocus', 'restoreFocus'],
  },
  outputs: {
...
i0.ɵɵngDeclareClassMetadata({
  ...
  propDecorators: {
    _deprecatedTakMenuTriggerFor: [
      {
        type: Input,
        args: ['tak-menu-trigger-for'],
      },
    ],
    menu: [
      {
        type: Input,
        args: ['takMenuTriggerFor'],
      },
    ],
    menuData: [
      {
        type: Input,
        args: ['takMenuTriggerData'],
      },
    ],
    restoreFocus: [
      {
        type: Input,
        args: ['takMenuTriggerRestoreFocus'],
      },
    ],
    menuOpened: [
      {
...
export class TakMenuTrigger extends _TakMenuTriggerBase {}
TakMenuTrigger.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: TakMenuTrigger,
...
TakMenuTrigger.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: TakMenuTrigger,
  selector: '[tak-menu-trigger-for], [takMenuTriggerFor]',
  host: { classAttribute: 'tak-menu-trigger' },
  exportAs: ['takMenuTrigger'],
