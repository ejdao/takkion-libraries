 ...
 */
export const TAK_MENU_CONTENT = new InjectionToken('TakMenuContent');
export class _TakMenuContentBase {
  constructor(
    _template,
 ...
 */
export class TakMenuContent extends _TakMenuContentBase {}
