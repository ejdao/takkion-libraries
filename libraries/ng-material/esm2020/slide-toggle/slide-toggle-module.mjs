...
import { TakSlideToggle } from './slide-toggle';
import { TakSlideToggleRequiredValidator } from './slide-toggle-required-validator';
import * as i0 from '@angular/core';
/** This module is used by both original and MDC-based slide-toggle implementations. */
export class _TakSlideToggleRequiredValidatorModule {}
...
export class TakSlideToggleModule {}
