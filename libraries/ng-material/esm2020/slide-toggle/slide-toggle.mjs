...
import { TAK_SLIDE_TOGGLE_DEFAULT_OPTIONS } from './slide-toggle-config';
...
export class _TakSlideToggleBase extends _TakSlideToggleMixinBase {
  constructor(
    elementRef,
    _focusMonitor,
    _changeDetectorRef,
...
export class TakSlideToggle extends _TakSlideToggleBase {
