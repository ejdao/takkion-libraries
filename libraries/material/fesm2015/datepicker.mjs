...
import { A11yModule } from '@takkion/cdk/a11y';
import * as i9 from '@takkion/cdk/overlay';
import { Overlay, FlexibleConnectedPositionStrategy, OverlayConfig, OverlayModule } from '@takkion/cdk/overlay';
import * as i6 from '@takkion/cdk/portal';
import { ComponentPortal, TemplatePortal, PortalModule } from '@takkion/cdk/portal';
...
import * as i1$1 from '@takkion/material/core';
import { DateAdapter, MAT_DATE_FORMATS, mixinColor, mixinErrorState, MatCommonModule } from '@takkion/material/core';
import { Subject, Subscription, merge, of } from 'rxjs';
import { ESCAPE, hasModifierKey, SPACE, ENTER, PAGE_DOWN, PAGE_UP, END, HOME, DOWN_ARROW, UP_ARROW, RIGHT_ARROW, LEFT_ARROW, BACKSPACE } from '@takkion/cdk/keycodes';
...
import * as i2$1 from '@takkion/material/form-field';
