...
import { SharedResizeObserver } from '@takkion/cdk/observers/private';
...
class MatFormFieldNotchedOutline {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {
        properties: { 'class.mdc-notched-outline--notched': 'open' },
        classAttribute: 'mdc-notched-outline',
      },
      viewQueries: [
        { propertyName: '_notch', first: true, predicate: ['notch'], descendants: true },
      ],
      ngImport: i0,
      template:
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      queries: [
        ...
        { propertyName: '_suffixChildren', predicate: MAT_SUFFIX, descendants: true },
        { propertyName: '_errorChildren', predicate: MAT_ERROR, descendants: true },
        { propertyName: '_hintChildren', predicate: MatHint, descendants: true },
      ],
      viewQueries: [
        { propertyName: '_textField', first: true, predicate: ['textField'], descendants: true },
        {
