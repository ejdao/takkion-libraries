...
export { MatOptgroup, MatOption } from '@takkion/material/core';
...
import * as i1$1 from '@takkion/cdk/overlay';
import { Overlay, OverlayConfig, OverlayModule } from '@takkion/cdk/overlay';
import {
  ActiveDescendantKeyManager,
  removeAriaReferencedId,
  addAriaReferencedId,
} from '@takkion/cdk/a11y';
import { coerceStringArray } from '@takkion/cdk/coercion';
import * as i1 from '@takkion/cdk/platform';
import { _getEventTarget } from '@takkion/cdk/platform';
import { trigger, state, style, transition, group, animate } from '@angular/animations';
import { Subscription, Subject, defer, merge, of, fromEvent } from 'rxjs';
import { ESCAPE, hasModifierKey, UP_ARROW, ENTER, DOWN_ARROW, TAB } from '@takkion/cdk/keycodes';
import { TemplatePortal } from '@takkion/cdk/portal';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import * as i4 from '@takkion/material/form-field';
import { MAT_FORM_FIELD } from '@takkion/material/form-field';
...
class MatAutocomplete {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: i0.ElementRef },
        { token: MAT_AUTOCOMPLETE_DEFAULT_OPTIONS },
        { token: i1.Platform },
      ],
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: { classAttribute: 'mat-mdc-autocomplete' },
      providers: [{ provide: MAT_OPTION_PARENT_COMPONENT, useExisting: MatAutocomplete }],
      queries: [
        { propertyName: 'options', predicate: MatOption, descendants: true },
        { propertyName: 'optionGroups', predicate: MAT_OPTGROUP, descendants: true },
      ],
      viewQueries: [
        {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: i0.NgZone },
        { token: i0.ChangeDetectorRef },
        { token: MAT_AUTOCOMPLETE_SCROLL_STRATEGY },
        { token: i2.Directionality, optional: true },
        { token: MAT_FORM_FIELD, host: true, optional: true },
        { token: DOCUMENT, optional: true },
        { token: i3.ViewportRuler },
        { token: MAT_AUTOCOMPLETE_DEFAULT_OPTIONS, optional: true },
      ],
      target: i0.ɵɵFactoryTarget.Directive,
    });
  }
