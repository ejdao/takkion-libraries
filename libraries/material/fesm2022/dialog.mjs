...
import { CdkDialogContainer, Dialog, DialogConfig, DialogModule } from '@takkion/cdk/dialog';
import { coerceNumberProperty } from '@takkion/cdk/coercion';
import { CdkPortalOutlet, PortalModule } from '@takkion/cdk/portal';
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_DIALOG_SCROLL_STRATEGY },
        { token: MatDialog, optional: true, skipSelf: true },
