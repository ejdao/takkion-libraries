import { CdkMonitorFocus, CdkTrapFocus, A11yModule } from '@takkion/cdk/a11y';
import * as i4 from '@takkion/cdk/overlay';
import {
  Overlay,
  FlexibleConnectedPositionStrategy,
  OverlayConfig,
  OverlayModule,
} from '@takkion/cdk/overlay';
import {
  ComponentPortal,
  CdkPortalOutlet,
  TemplatePortal,
  PortalModule,
} from '@takkion/cdk/portal';
...
import { MatButton, MatIconButton, MatButtonModule } from '@takkion/material/button';
...
} from '@takkion/cdk/platform';
import { take, startWith, filter } from 'rxjs/operators';
import { coerceStringArray } from '@takkion/cdk/coercion';
import { trigger, transition, animate, keyframes, style, state } from '@angular/animations';
import * as i2$1 from '@angular/forms';
import { NG_VALUE_ACCESSOR, NG_VALIDATORS, Validators, NgControl } from '@angular/forms';
import { MAT_FORM_FIELD, MatFormFieldControl } from '@takkion/material/form-field';
import { MAT_INPUT_VALUE_ACCESSOR } from '@takkion/material/input';
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_DATE_RANGE_SELECTION_STRATEGY, optional: true },
      ],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
...
class MatCalendar {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      viewQueries: [
        { propertyName: 'monthView', first: true, predicate: MatMonthView, descendants: true },
        { propertyName: 'yearView', first: true, predicate: MatYearView, descendants: true },
        {
...
class MatDatepickerContent {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      viewQueries: [
        { propertyName: '_calendar', first: true, predicate: MatCalendar, descendants: true },
      ],
...
class MatDatepickerToggle {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      viewQueries: [
        { propertyName: '_button', first: true, predicate: ['button'], descendants: true },
      ],
...
class MatDateRangeInputPartBase extends MatDatepickerInputBase {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: MAT_DATE_RANGE_INPUT_PARENT },
        { token: i0.ElementRef },
...
class MatDateRangeInput {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: i0.ChangeDetectorRef },
        { token: i0.ElementRef },
        { token: i2$1.ControlContainer, optional: true, self: true },
        { token: i1.DateAdapter, optional: true },
        { token: MAT_FORM_FIELD, optional: true },
      ],
      target: i0.ɵɵFactoryTarget.Component,
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      queries: [
        { propertyName: '_startInput', first: true, predicate: MatStartDate, descendants: true },
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: () => [{ type: MatDatepickerBase }, { type: i0.ViewContainerRef }],
  propDecorators: {
    _template: [
      {
        type: ViewChild,
