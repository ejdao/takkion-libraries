...
import { Overlay, OverlayModule } from '@takkion/cdk/overlay';
...
class MatTooltip {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_TOOLTIP_DEFAULT_OPTIONS, optional: true },
        { token: DOCUMENT },
      ],
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      host: {
        properties: { 'class.mat-mdc-tooltip-disabled': 'disabled' },
