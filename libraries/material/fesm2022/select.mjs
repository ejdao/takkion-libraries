...
import {
  ...
  MatFormFieldControl,
  MatFormFieldModule,
} from '@takkion/material/form-field';
export {
  MatError,
  MatFormField,
  MatHint,
...
class MatSelect {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_SELECT_SCROLL_STRATEGY },
        { token: i5.LiveAnnouncer },
        { token: MAT_SELECT_CONFIG, optional: true },
      ],
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {
        attributes: { role: 'combobox', 'aria-autocomplete': 'none', 'aria-haspopup': 'listbox' },
