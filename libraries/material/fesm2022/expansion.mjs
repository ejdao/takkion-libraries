import { CdkAccordionItem, CdkAccordion, CdkAccordionModule } from '@takkion/cdk/accordion';
import { TemplatePortal, CdkPortalOutlet, PortalModule } from '@takkion/cdk/portal';
...
import { ENTER, hasModifierKey, SPACE } from '@takkion/cdk/keycodes';
 ...
 */
const MAT_EXPANSION_PANEL_DEFAULT_OPTIONS = new InjectionToken(
...
class MatExpansionPanel extends CdkAccordionItem {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: MAT_ACCORDION, optional: true, skipSelf: true },
...
class MatExpansionPanelHeader {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: MatExpansionPanel, host: true },
        { token: i0.ElementRef },
...
class MatAccordion extends CdkAccordion {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      host: {
        properties: { 'class.mat-accordion-multi': 'this.multi' },
      ...
      queries: [
        { propertyName: '_headers', predicate: MatExpansionPanelHeader, descendants: true },
      ],
