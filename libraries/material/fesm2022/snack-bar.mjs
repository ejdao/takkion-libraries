...
import { MatButton, MatButtonModule } from '@takkion/material/button';
...
import * as i3 from '@takkion/cdk/layout';
import { Breakpoints } from '@takkion/cdk/layout';
import * as i1$1 from '@takkion/cdk/overlay';
import { OverlayConfig, OverlayModule } from '@takkion/cdk/overlay';
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      dependencies: [
        ...
        { kind: 'directive', type: MatSnackBarActions, selector: '[matSnackBarActions]' },
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MatSnackBar, optional: true, skipSelf: true },
