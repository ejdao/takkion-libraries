...
import { MatRipple, MAT_RIPPLE_GLOBAL_OPTIONS, MatCommonModule } from '@takkion/material/core';
import { CdkPortal, TemplatePortal, CdkPortalOutlet } from '@takkion/cdk/portal';
import {
  Subject,
  fromEvent,
  of,
...
import { normalizePassiveListenerOptions, Platform } from '@takkion/cdk/platform';
import * as i2 from '@takkion/cdk/bidi';
import * as i4 from '@takkion/cdk/a11y';
import { FocusKeyManager, CdkMonitorFocus } from '@takkion/cdk/a11y';
import { hasModifierKey, SPACE, ENTER } from '@takkion/cdk/keycodes';
import {
  takeUntil,
  take,
  startWith,
...
class MatTabLabelWrapper extends InkBarItem {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      inputs: { disabled: ['disabled', 'disabled', booleanAttribute] },
      host: {
        properties: {
...
class MatTabBody {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      dependencies: [
        { kind: 'directive', type: MatTabBodyPortal, selector: '[matTabBodyHost]' },
