...
import { ENTER, SPACE, BACKSPACE, DELETE, TAB, hasModifierKey } from '@takkion/cdk/keycodes';
import * as i1$1 from '@takkion/cdk/bidi';
import * as i2 from '@angular/forms';
import { NG_VALUE_ACCESSOR, Validators } from '@angular/forms';
import * as i1$2 from '@takkion/material/form-field';
import { MatFormFieldControl, MAT_FORM_FIELD } from '@takkion/material/form-field';
...
class MatChipInput {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: i0.ElementRef },
        { token: MAT_CHIPS_DEFAULT_OPTIONS },
