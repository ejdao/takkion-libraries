...
import { CdkDialogContainer, Dialog, DialogModule } from '@takkion/cdk/dialog';
...
import { AnimationDurations, AnimationCurves, MatCommonModule } from '@takkion/material/core';
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: i3.Overlay },
        { token: i0.Injector },
        { token: MatBottomSheet, optional: true, skipSelf: true },
