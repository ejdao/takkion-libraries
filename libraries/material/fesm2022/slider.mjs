...
class MatSliderVisualThumb {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      viewQueries: [
        { propertyName: '_ripple', first: true, predicate: MatRipple, descendants: true },
        { propertyName: '_knob', first: true, predicate: ['knob'], descendants: true },
        {
...
class MatSlider {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      queries: [
        { propertyName: '_input', first: true, predicate: MAT_SLIDER_THUMB, descendants: true },
...
class MatSliderThumb {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      inputs: { value: ['value', 'value', numberAttribute] },
