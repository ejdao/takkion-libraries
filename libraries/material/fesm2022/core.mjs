...
import { BidiModule } from '@takkion/cdk/bidi';
import { VERSION as VERSION$1 } from '@takkion/cdk';
import { DOCUMENT } from '@angular/common';
import * as i1$1 from '@takkion/cdk/platform';
import {
  Platform,
  _isTestEnvironment,
...
import { ENTER, SPACE, hasModifierKey } from '@takkion/cdk/keycodes';
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MATERIAL_SANITY_CHECKS, optional: true },
        { token: DOCUMENT },
      ],
...
class NativeDateAdapter extends DateAdapter {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [{ token: MAT_DATE_LOCALE, optional: true }],
...
class MatRipple {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      host: {
        properties: { 'class.mat-ripple-unbounded': 'unbounded' },
...
class MatOptgroup {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      inputs: { label: 'label', disabled: ['disabled', 'disabled', booleanAttribute] },
      host: {
        properties: {
...
class MatOption {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_OPTION_PARENT_COMPONENT, optional: true },
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      isStandalone: true,
      selector: 'mat-option',
      inputs: { value: 'value', id: 'id', disabled: ['disabled', 'disabled', booleanAttribute] },
...
class _MatInternalFormField {
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {
        properties: { 'class.mdc-form-field--align-end': 'labelPosition === "before"' },
