...
export declare class MatSlider implements AfterViewInit, OnDestroy, _MatSlider {
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<
    MatSlider,
    [null, null, null, { optional: true }, { optional: true }, { optional: true }]
  >;
...
export declare class MatSliderModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    [
      ...
      typeof i2.MatSlider,
      typeof i3.MatSliderThumb,
      typeof i3.MatSliderRangeThumb,
      typeof i4.MatSliderVisualThumb,
    ],
    [typeof i2.MatSlider, typeof i3.MatSliderThumb, typeof i3.MatSliderRangeThumb]
  >;
...
export declare class MatSliderThumb implements _MatSliderThumb, OnDestroy, ControlValueAccessor {
  ...
  _updateThumbUI(options?: { withAnimation: boolean }): void;
  /**
   * Sets the input's value.
   * @param value The new value of the input
   * @docs-private
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    { valueChange: 'valueChange'; dragStart: 'dragStart'; dragEnd: 'dragEnd' },
    never,
    never,
    true,
    never
 ...
 * @docs-private
 */
export declare class MatSliderVisualThumb
  implements _MatSliderVisualThumb, AfterViewInit, OnDestroy
{
  readonly _cdr: ChangeDetectorRef;
