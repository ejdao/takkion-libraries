...
import { CdkStep } from '@takkion/cdk/stepper';
import { CdkStepLabel } from '@takkion/cdk/stepper';
import { CdkStepper } from '@takkion/cdk/stepper';
import { CdkStepperNext } from '@takkion/cdk/stepper';
import { CdkStepperPrevious } from '@takkion/cdk/stepper';
...
import * as i10 from '@takkion/material/button';
import * as i11 from '@takkion/cdk/stepper';
import * as i12 from '@takkion/material/icon';
import * as i7 from '@takkion/material/core';
import * as i8 from '@angular/common';
import * as i9 from '@takkion/cdk/portal';
import { NgForm } from '@angular/forms';
import { OnDestroy } from '@angular/core';
import { Optional } from '@angular/core';
import { QueryList } from '@angular/core';
import { StepperOptions } from '@takkion/cdk/stepper';
import { StepperOrientation } from '@takkion/cdk/stepper';
import { StepState } from '@takkion/cdk/stepper';
...
declare namespace i3 {
  export { MatStepperNext, MatStepperPrevious };
}
...
declare namespace i5 {
  export { MatStepperIconContext, MatStepperIcon };
}
...
/** @docs-private */
export declare function MAT_STEPPER_INTL_PROVIDER_FACTORY(
  parentIntl: MatStepperIntl
): MatStepperIntl;

export declare class MatStep
  extends CdkStep
...
/** @docs-private */
declare const _MatStepHeaderBase: _Constructor<CanColor> &
...
export declare class MatStepperModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    [
      typeof i1.MatStep,
      typeof i2.MatStepLabel,
      typeof i1.MatStepper,
      typeof i3.MatStepperNext,
      typeof i3.MatStepperPrevious,
      typeof i4.MatStepHeader,
      typeof i5.MatStepperIcon,
      typeof i6.MatStepContent,
    ],
    [
