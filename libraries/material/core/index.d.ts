...
import { HighContrastModeDetector } from '@takkion/cdk/a11y';
...
declare type CanDisableRippleCtor = _Constructor<CanDisableRipple> &
...
export declare class _ErrorStateTracker {
  ...
  constructor(
    _defaultMatcher: ErrorStateMatcher_2 | null,
    ngControl: NgControl | null,
...
declare namespace i5 {
  export { MAT_OPTGROUP, MatOptgroup };
}
...
export declare class _MatInternalFormField {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    { labelPosition: { alias: 'labelPosition'; required: true } },
    {},
    never,
    ['*'],
    true,
...
export declare class MatLineModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    MatLineModule,
    never,
    [typeof i1_2.MatCommonModule, typeof MatLine],
...
export declare class MatOptionModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    never,
    [
      typeof i1_3.MatRippleModule,
      typeof i1_2.MatCommonModule,
      typeof i3.MatPseudoCheckboxModule,
      typeof i4.MatOption,
      typeof i5.MatOptgroup,
    ],
    [typeof i4.MatOption, typeof i5.MatOptgroup]
  >;
...
export declare class MatPseudoCheckboxModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    ...
    never,
    [typeof i1_2.MatCommonModule, typeof i2_2.MatPseudoCheckbox],
...
export declare class MatRippleModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    MatRippleModule,
    never,
    [typeof i1_2.MatCommonModule, typeof i2.MatRipple],
    [typeof i2.MatRipple, typeof i1_2.MatCommonModule]
  >;
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinColor<T extends _AbstractConstructor<HasElementRef>>(
  base: T,
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinDisabled<T extends _AbstractConstructor<{}>>(
  base: T
): CanDisableCtor & T;
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinDisableRipple<T extends _AbstractConstructor<{}>>(
  base: T
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinErrorState<T extends _AbstractConstructor<HasErrorState>>(
  base: T
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinInitialized<T extends _Constructor<{}>>(
  base: T
 ...
 * @breaking-change 19.0.0
 */
export declare function mixinTabIndex<T extends _AbstractConstructor<CanDisable>>(
  base: T,
  defaultTabIndex?: number
): HasTabIndexCtor & T;
 ...
 * @docs-private
 */
export declare function setLines(
