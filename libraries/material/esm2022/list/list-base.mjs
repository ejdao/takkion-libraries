...
import { MAT_RIPPLE_GLOBAL_OPTIONS, RippleRenderer } from '@takkion/material/core';
...
export class MatListItemBase {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        { token: i0.ElementRef },
        { token: i0.NgZone },
        { token: MatListBase, optional: true },
        { token: i1.Platform },
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      queries: [
        { propertyName: '_avatars', predicate: MatListItemAvatar },
        { propertyName: '_icons', predicate: MatListItemIcon },
      ],
      ngImport: i0,
    });
  }
