...
import { getSupportedInputTypes, Platform } from '@takkion/cdk/platform';
...
import { ErrorStateMatcher, _ErrorStateTracker } from '@takkion/material/core';
import { MatFormFieldControl, MatFormField, MAT_FORM_FIELD } from '@takkion/material/form-field';
...
import * as i5 from '@takkion/material/form-field';
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      deps: [
        ...
        { token: MAT_INPUT_VALUE_ACCESSOR, optional: true, self: true },
