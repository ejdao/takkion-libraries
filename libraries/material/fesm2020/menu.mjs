...
import { FocusKeyManager, isFakeTouchstartFromScreenReader, isFakeMousedownFromScreenReader } from '@takkion/cdk/a11y';
import { coerceBooleanProperty } from '@takkion/cdk/coercion';
import { UP_ARROW, DOWN_ARROW, RIGHT_ARROW, LEFT_ARROW, ESCAPE, hasModifierKey, ENTER, SPACE } from '@takkion/cdk/keycodes';
...
import { TemplatePortal, DomPortalOutlet } from '@takkion/cdk/portal';
import * as i2 from '@angular/common';
import { DOCUMENT, CommonModule } from '@angular/common';
import * as i3 from '@takkion/material/core';
import { mixinDisableRipple, mixinDisabled, MatCommonModule, MatRippleModule } from '@takkion/material/core';
import * as i3$1 from '@takkion/cdk/bidi';
