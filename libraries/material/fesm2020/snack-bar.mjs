...
import { OverlayModule, OverlayConfig } from '@takkion/cdk/overlay';
import * as i3$1 from '@takkion/cdk/portal';
import { BasePortalOutlet, CdkPortalOutlet, PortalModule, ComponentPortal, TemplatePortal } from '@takkion/cdk/portal';
...
import * as i2$1 from '@takkion/cdk/a11y';
import * as i3$2 from '@takkion/cdk/layout';
