...
import { mixinTabIndex, mixinColor, mixinDisabled, MatCommonModule } from '@takkion/material/core';
...
import { hasModifierKey, DOWN_ARROW, RIGHT_ARROW, UP_ARROW, LEFT_ARROW, HOME, END, PAGE_DOWN, PAGE_UP } from '@takkion/cdk/keycodes';
