...
import { AutofillMonitor } from '@takkion/cdk/text-field';
...
import * as i2 from '@takkion/material/form-field';
import * as i4 from '@takkion/cdk/text-field';
  ...
  implements MatFormFieldControl<any>, OnChanges, OnDestroy, AfterViewInit, DoCheck
{
  ...
  constructor(
    _elementRef: ElementRef<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>,
    _platform: Platform,
    ngControl: NgControl,
    parentForm: NgForm,
...
export declare class MatInputModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    MatInputModule,
    never,
    [typeof i1.MatCommonModule, typeof i2.MatFormFieldModule, typeof i3.MatInput],
    [
      typeof i3.MatInput,
      typeof i2.MatFormFieldModule,
      typeof i4.TextFieldModule,
