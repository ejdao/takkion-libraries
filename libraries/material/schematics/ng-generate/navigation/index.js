...
const schematics_2 = require('@takkion/cdk/schematics');
/**
  ...
  return async host => {
    ...
    if (!isStandalone) {
      ...
      (0, schematics_2.addModuleImportToModule)(
        ...
        modulePath,
        'MatToolbarModule',
        '@takkion/material/toolbar'
      );
      (0, schematics_2.addModuleImportToModule)(
        host,
        modulePath,
        'MatButtonModule',
        '@takkion/material/button'
      );
      (0, schematics_2.addModuleImportToModule)(
        host,
        modulePath,
        'MatSidenavModule',
        '@takkion/material/sidenav'
      );
      (0, schematics_2.addModuleImportToModule)(
        host,
        modulePath,
        'MatIconModule',
        '@takkion/material/icon'
      );
      (0, schematics_2.addModuleImportToModule)(
        host,
        modulePath,
        'MatListModule',
        '@takkion/material/list'
      );
    }
  };
}
