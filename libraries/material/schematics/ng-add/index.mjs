 ...
 * can be no dependency on `@takkion/material` in the `package.json` file, and we need
 ...
 * automatically executed if developers run `ng add @takkion/material`.
 *
...
function default_1(options) {
  return (host, context) => {
    ...
    const ngCoreVersionTag = (0, package_config_1.getPackageVersionFromPackageJson)(
      host,
      '@angular/core'
    );
    const materialVersionRange = (0, package_config_1.getPackageVersionFromPackageJson)(
      host,
      '@takkion/material'
    );
    const angularDependencyVersion = ngCoreVersionTag || `^17.0.0 || ^18.0.0`;
    // The CLI inserts `@takkion/material` into the `package.json` before this schematic runs.
    ...
    if (materialVersionRange === null) {
      (0, package_config_1.addPackageToPackageJson)(
        host,
        '@takkion/material',
        fallbackMaterialVersionRange
      );
    }
    (0, package_config_1.addPackageToPackageJson)(
      host,
