...
var require_legacy_imports_error = __commonJS({
  'bazel-out/k8-fastbuild/bin/src/material/schematics/ng-update/migrations/legacy-imports-error.js'(
    ...
    var LEGACY_IMPORTS_START = '@takkion/material/legacy-';
        ...
        __async(this, null, function* () {
          ...
          if (tree.exists('package.json')) {
            ...
            if (packageJson !== null && packageJson['dependencies']) {
              packageJson['dependencies']['@takkion/material'] = '^16.2.0';
...
`,
    ...
    function checkThemeBaseMixins(fileContent) {
      ...
      const materialNamespaces = getAtUseNamespaces(content, '@takkion/material');
...
var require_theme_base_v17 = __commonJS({
  'bazel-out/k8-fastbuild/bin/src/material/schematics/ng-update/migrations/theme-base-v17/index.js'(
    ...
    var schematics_1 = require('@takkion/cdk/schematics');
      ...
      postAnalysis() {
        ...
        for (const stylesheet of this.visitedSassStylesheets) {
          ...
          const migratedContent = content
            ? (0, migration_1.addThemeBaseMixins)(content, _ThemeBaseMigration.missingBaseMixins)
            : content;
        ...
        if (_ThemeBaseMigration.migratedFileCount === 0) {
          const mixinsText = [..._ThemeBaseMigration.missingBaseMixins]
            .sort()
            .map(m => `mat.${m}($theme)`)
            .join('\n');
          this.failures.push({
...
${mixinsText}`,
      ...
      static globalPostMigration(_tree, _targetVersion, context) {
        ...
        if (fileCount > 0 && mixinCount > 0) {
          ...
          context.logger.info(
            `Added ${mixinCountText} to ${fileCountText}. Please search for, and address, any "TODO(v17)" comments.`
          );
        }
...
var import_schematics = require('@takkion/cdk/schematics');
...
function updateToV17() {
  return (0, import_legacy_imports_error.legacyImportsError)(
    (0, import_schematics.createMigrationSchematicRule)(
      import_schematics.TargetVersion.V17,
      materialMigrations,
      import_upgrade_data.materialUpgradeData,
      onMigrationComplete
    )
  );
}
