...
CdkTextColumn.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  type: CdkTextColumn,
  deps: [
    { token: i1.CdkTable, optional: true },
...
CdkTextColumn.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  isInline: true,
  dependencies: [
    { kind: 'directive', type: i2.CdkCellDef, selector: '[cdkCellDef]' },
    { kind: 'directive', type: i2.CdkHeaderCellDef, selector: '[cdkHeaderCellDef]' },
    {
      kind: 'directive',
    ...
    { kind: 'directive', type: i2.CdkHeaderCell, selector: 'cdk-header-cell, th[cdk-header-cell]' },
  ],
