    ...
    if (source.hasOwnProperty(key)) {
      ...
      if (value) {
        dest.setProperty(
          ...
          value,
          (
            importantProperties === null || importantProperties === void 0
              ? void 0
              : importantProperties.has(key)
          )
            ? 'important'
            : ''
        );
...
class DragRef {
      ...
      return new Promise(resolve => {
        const handler = event => {
          ...
          if (
            ...
            (_a = this._preview) === null || _a === void 0
              ? void 0
              : _a.removeEventListener('transitionend', handler);
            resolve();
  ...
  _applyPreviewTransform(x, y) {
    ...
    const initialTransform = (
      (_a = this._previewTemplate) === null || _a === void 0 ? void 0 : _a.template
    )
      ? undefined
      : this._initialTransform;
    const transform = getTransform(x, y);
  ...
  _getViewportScrollPosition() {
    var _a;
    return (
      ((_a = this._parentPositions.positions.get(this._document)) === null || _a === void 0
        ? void 0
        : _a.scrollPosition) || this._parentPositions.getViewportScrollPosition()
    );
  }
  /**
...
class SingleAxisSortStrategy {
  ...
  reset() {
    ...
    this._activeDraggables.forEach(item => {
      ...
      if (rootElement) {
        const initialTransform =
          (_a = this._itemPositions.find(p => p.drag === item)) === null || _a === void 0
            ? void 0
            : _a.initialTransform;
      ...
      interval(0, animationFrameScheduler)
        ...
        .subscribe(() => {
          ...
          if (this._horizontalScrollDirection === 1 /* AutoScrollHorizontalDirection.LEFT */) {
            ...
            this._horizontalScrollDirection === 2 /* AutoScrollHorizontalDirection.RIGHT */
          ) {
            node.scrollBy(scrollStep, 0);
          }
        });
...
DragDropRegistry.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
...
DragDropRegistry.ɵprov = i0.ɵɵngDeclareInjectable({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDropRegistry,
...
DragDrop.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDrop,
...
DragDrop.ɵprov = i0.ɵɵngDeclareInjectable({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDrop,
...
CdkDropListGroup.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
...
CdkDropListGroup.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: CdkDropListGroup,
...
CdkDropList.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: CdkDropList,
  deps: [
    ...
    { token: CDK_DROP_LIST_GROUP, optional: true, skipSelf: true },
    { token: CDK_DRAG_CONFIG, optional: true },
  ],
  target: i0.ɵɵFactoryTarget.Directive,
});
CdkDropList.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: CdkDropList,
...
CdkDragHandle.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: CdkDragHandle,
...
CdkDragHandle.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: CdkDragHandle,
...
CdkDragPlaceholder.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
...
CdkDragPlaceholder.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: CdkDragPlaceholder,
...
CdkDragPreview.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: CdkDragPreview,
...
CdkDragPreview.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.0',
  type: CdkDragPreview,
    ...
    if (this.rootElementSelector) {
      rootElement =
        element.closest !== undefined
          ...
          ? void 0
          : _a.closest(this.rootElementSelector);
    }
    ...
    ref.beforeStarted.pipe(take(1)).subscribe(() => {
      ...
      while (parent) {
        if (parent.classList.contains(DRAG_HOST_CLASS)) {
          ref.withParent(
            ((_a = CdkDrag._dragInstances.find(drag => {
...
DragDropModule.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDropModule,
...
DragDropModule.ɵmod = i0.ɵɵngDeclareNgModule({
  minVersion: '14.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDropModule,
...
DragDropModule.ɵinj = i0.ɵɵngDeclareInjector({
  minVersion: '12.0.0',
  version: '14.2.0',
  ngImport: i0,
  type: DragDropModule,
