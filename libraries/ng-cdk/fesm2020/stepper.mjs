...
class CdkStep {
  ...
  ngOnChanges() {
    // Since basically all inputs of the TakStep get proxied through the view down to the
    // underlying TakStepHeader, we have to make sure that change detection runs correctly.
...
class CdkStepper {
  ...
  set orientation(value) {
    // This is a protected method so that `TakStepper` can hook into it.
