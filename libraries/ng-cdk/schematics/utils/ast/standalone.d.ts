 ...
 */
export declare function importsProvidersFrom(
  tree: Tree,
  filePath: string,
  className: string
): boolean;
 ...
 */
export declare function addModuleImportToStandaloneBootstrap(
  tree: Tree,
  filePath: string,
  moduleName: string,
  modulePath: string
...
export declare function findBootstrapApplicationCall(
