...
class ComponentResourceCollector {
      ...
      if (propertyName === 'templateUrl' && ts.isStringLiteralLike(property.initializer)) {
        ...
        if (fileContent) {
          ...
          this.resolvedTemplates.push({
            ...
            inline: false,
            start: 0,
            getCharacterAndLineOfPosition: p =>
              (0, line_mappings_1.getLineAndCharacterFromPosition)(lineStartsMap, p),
          });
        }
      }
    });
  ...
  resolveExternalStylesheet(filePath, container) {
    ...
    return {
      ...
      start: 0,
      getCharacterAndLineOfPosition: pos =>
        (0, line_mappings_1.getLineAndCharacterFromPosition)(lineStartsMap, pos),
    };
  }
}
